    ...
    <header>
        ...
        <div class="container-fluid" style="text-align:center; padding-top:50px; color: #CD1E79;">
            ...
            <form action="adminedit.php" method="POST" enctype="multipart/form-data" >
                <input type="text" placeholder="Enter admin name" name="name" required value="<?php echo $fullname;?>"><br>
                <input type="email" placeholder="Enter admin email" name="user_email" value="<?php echo $useremail; ?>" required><br>
                <br/>
                <br><button type="submit" name='btnSubmit' class="mybtn">EDIT ADMIN</button><br/><br/>
            </form>
        </div>
        <?php
            if(isset($_POST['btnSubmit'])){
                ...
                if($user->edit_user($uid, $name, $useremail)){
                    echo '<script type="text/javascript">';
                    echo 'setTimeout(function () { swal("Success!","Admin Details Edited Successfully","success");';
                    echo '}, 0);</script>';
